...
def process_song_file(cur, filepath):
    """Reads song data file, selects required fields, and inserts them into song and artist tables.
        Parameters:
            cur (psycopg2.cursor()): Cursor of sparkifydb database
            filepath (str): Filepath of data (song_data)
    """
    # open song file
